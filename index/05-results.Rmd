...
vary for sections taught in base R. However, the two sections—both employed the
...
advanced instruction from the teaching assistants, or more discussion about the 
final project in lecture that encouraged groups to satisfy the requirements for 
higher creativty scores.
...
depth category than projects from the other classes.
...
to the reasoning stated in the Creativity metric section, this may be due to the
emphasis and quality of instruction from the teaching assistants (which differ
by class section) in regards to creating plots with at least three variables.
