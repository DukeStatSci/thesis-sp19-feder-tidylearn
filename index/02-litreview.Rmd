...
Since this post was released prior to the official release of the tidyverse, Dr. David Robinson, a well-known data scientist and instructor, focuses solely on one of its packages, `ggplot2`. Robinson argues that `ggplot2` should be taught before base R for two reasons:
...
Dr. Hadley Wickham, who is considered to be the father of the tidyverse, discusses how to work with and create tidy datasets. Many popular base R functions require tidy data inputs, as well as many tidyverse commands, which were created to work symmetrically with tidy datasets.
