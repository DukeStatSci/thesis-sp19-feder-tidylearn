...
indicator variables. Code snippets will be provided in the following chapter to
display examples that scored a one for distinct covariates.
...
The metric ranges from 0-2 and is scored with 1 point for each of the following:
