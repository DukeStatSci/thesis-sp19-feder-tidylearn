...
indicator variables. They were analyzed for these aspects specifically since they
...
than covering a multitude of topics with little breadth, the depth metric qualifies
...
among more than two variables (GAISE).” The metric ranges from 0-2 and is scored
...
are related, as a project could not score a one for the interpretation if it did
...
on the x- and y-axes. To receive a score of a one, projects were required to produce
...
multivariate visualization would not receive a score of a one. By insufficient, the
project does not need to address every aspect of the visualization, but
it needs to discuss a key insight to help bolster the overall final project.
