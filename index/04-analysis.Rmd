...
ggplot(data = creative_counts, aes(x = creative, y = prop, fill = tidyverse)) +
  ...
  scale_fill_viridis_d(name = "Syntax", labels = c("Base R", "Tidyverse")) +
  labs(x = "Creativity Score", y = "Proportion of Projects", title = "Tidyverse Projects Tend to be More Creative")
```
...
ggplot(data = project_counts, aes(x = theme, y = prop, fill = tidyverse)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  scale_fill_viridis_d(name = "Syntax", labels = c("Base R", "Tidyverse")) +
  labs(x = "Project Quality", y = "Proportion of Projects", title = "Tidyverse Projects Are Usually of a Higher Quality")
```
