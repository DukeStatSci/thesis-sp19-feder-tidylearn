...
creative_counts <- creative_counts %>%
  filter(creative == 0 | creative == 1 | creative == 2 | creative == 3) %>%
...
ggplot(data = creative_counts, aes(x = creative, y = prop, fill = tidyverse, 
  ...
  labs(x = "Creativity Score", y = "Proportion of Projects", title = "Tidyverse 
       Projects Tend to be More Creative")
```
...
ggplot(data = project_counts, aes(x = theme, y = prop, fill = tidyverse, group = tidyverse)) +
  ...
  scale_fill_viridis_d(name = "Syntax", labels = c("Base R", "Tidyverse")) +
  labs(x = "Project Quality", y = "Proportion of Projects", title = "Tidyverse 
       Projects Are Usually of a Higher Quality")
```
